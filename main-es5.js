...
var DetailsPageComponent = /** @class */ (function () {
    function DetailsPageComponent(detailsService, route, router) {
    ...
    DetailsPageComponent.prototype.ngOnInit = function () {
        ...
        this.route.params
            ...
            _this.getPokemons(params['pokemonName']);
        });
    };
    DetailsPageComponent.prototype.getPokemons = function (pokemonName) {
        var _this = this;
        this.detailsService.getPokemonDetails(pokemonName)
            .subscribe(function (data) {
            _this.initializePokemonDetails(data);
        }, function (err) {
            if (err.status === 404) {
        ...
        this.detailsService.getPokemonSpeciesData(pokemonName)
            .subscribe(function (data) {
            _this.initializeSpeciesData(data);
        }, function (err) { return console.log('HTTP Error', err); });
    };
    DetailsPageComponent.prototype.initializePokemonDetails = function (data) {
        var _this = this;
        ...
        data.stats.forEach(function (ele) {
            if (ele.stat.name === "hp") {
                _this.hp = ele.base_stat;
            }
            else if (ele.stat.name === "attack") {
                _this.attack = ele.base_stat;
            }
            else if (ele.stat.name === "defense") {
                _this.defence = ele.base_stat;
            }
            else if (ele.stat.name === "speed") {
                _this.speed = ele.base_stat;
            }
            else if (ele.stat.name === "special-attack") {
                _this.specialAttack = ele.base_stat;
            }
            else {
                _this.specialDefence = ele.base_stat;
            }
        });
        this.height = data.height;
        this.weight = data.weight;
        this.types = data.types.map(function (ele) {
            var temp = {
                name: ele.type.name,
                color: _this.TYPE_COLORS[ele.type.name]
            };
            return temp;
        });
    ...
    DetailsPageComponent.prototype.initializeSpeciesData = function (data) {
        var _this = this;
        data.flavor_text_entries.forEach(function (e) {
            if (e.language.name === 'en') {
                _this.description = e.flavor_text;
            }
        });
...
var DetailsService = /** @class */ (function () {
    ...
    DetailsService.prototype.getPokemonDetails = function (pokemonName) {
        return this.http.get(this.baseUrl + 'pokemon/' + pokemonName + '/');
    };
    DetailsService.prototype.getPokemonSpeciesData = function (pokemonName) {
...
var HomePageService = /** @class */ (function () {
    ...
    HomePageService.prototype.getPokemons = function (url) {
...
var HomePageComponent = /** @class */ (function () {
    ...
    HomePageComponent.prototype.onCloseClicked = function () {
        this.isDescriptionShown = false;
    };
    HomePageComponent.prototype.onNextClicked = function () {
        this.fetchPokemons(this.nextUrl);
    };
    HomePageComponent.prototype.onPreviousClicked = function () {
        this.fetchPokemons(this.previousUrl);
    };
    HomePageComponent.prototype.fetchPokemons = function (url) {
        var _this = this;
        this.HomePageService.getPokemons(url)
            .subscribe(function (data) {
            _this.pokemonData = data.results;
            _this.nextUrl = data.next;
            _this.previousUrl = data.previous;
            _this.isPreviousActive = _this.previousUrl != null ? true : false;
            _this.isNextActive = _this.nextUrl != null ? true : false;
        });
    };
...
var PokemonContainerComponent = /** @class */ (function () {
    function PokemonContainerComponent(DetailsService) {
        this.DetailsService = DetailsService;
        this.TYPE_COLORS = _constants__WEBPACK_IMPORTED_MODULE_2__["default"].TYPE_COLORS;
    }
    PokemonContainerComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.DetailsService.getPokemonDetails(this.pokemon.name)
            .subscribe(function (data) {
            _this.types = data.types.map(function (ele) {
                var temp = {
                    name: ele.type.name,
                    color: _this.TYPE_COLORS[ele.type.name]
                };
    ...
    PokemonContainerComponent.ctorParameters = function () { return [
    ...
    return PokemonContainerComponent;
}());
